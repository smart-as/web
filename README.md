...
An open source project for official documentation website of SmartAs app framework.

## Install site locally

SmartAs Web is a `go get` able project:

	$ go get github.com/smart-as/web

Switch to project root path:

	$ cd $GOPATH/src/github.com/smart-as/web
